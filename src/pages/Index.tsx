            ...
            >
              <div className="inline-block bg-white/25 backdrop-blur-sm rounded-3xl px-8 py-6 shadow-2xl border border-white/40 max-w-2xl">
                ...
                >
                  ...
                  <br /><br />
                  Желаю тебе, чтобы лид на хайп был вечным, кринж обходил стороной, челленджи были только лёгкими (типа «съесть тортик и не потолстеть»), а вайб был таким, что все вокруг говорили: «Это же шик! Это же Широкова!»
                  <br /><br />
                  Пусть твой кринж-метр всегда будет на нуле, а уровень рофла зашкаливает! И помни: ты настолько имба, что даже баги судьбы облетают тебя стороной. 💎
                  <br /><br />
                  С Днём Рождения! 🎉🎂🎈
                </p>
              </div>
