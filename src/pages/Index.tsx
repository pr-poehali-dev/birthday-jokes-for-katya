          ...
          <div className="w-full max-w-5xl">
            ...
            >
              <div className="inline-block bg-white/25 backdrop-blur-sm rounded-3xl px-8 py-6 shadow-2xl border border-white/40 max-w-2xl">
                ...
                >
                  "Катюша, в твой праздник желаем тебе быть счастливее, чем ребёнок в магазине игрушек, здоровее, чем этот текст выглядит, и моложе с каждым днём — хотя куда уж моложе! 🎈
                  <br /><br />
                  Пусть жизнь будет яркой, друзья — настоящими, а торт — без единой калории!"
                </p>
              </div>
            </div>
